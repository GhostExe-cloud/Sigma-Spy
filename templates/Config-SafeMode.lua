return {
    --// SAFE MODE CONFIG - Use this if game freezes
    
    --// Hooking - REDUCED TO MINIMAL
    ForceUseCustomComm = false,
    ReplaceMetaCallFunc = false,
    NoReceiveHooking = true,  -- DISABLED: Don't hook receives (common freeze cause)
    NoFunctionPatching = true, -- DISABLED: Skip function patches
    BlackListedServices = {
        "RobloxReplicatedStorage",
        "CoreGui",  -- Added: Don't hook CoreGui
        "CorePackages", -- Added: Don't hook CorePackages
        "Players", -- Added: Can cause freezes with PlayerAdded
    },
